...
<script type="text/javascript">
    ...
    <td class="row_img"><img src="/${value.product.product_thumbnail} " style="width:300px; height:300px;"  alt="compare-img" /></td>
            ...
            <tr class="pr_remove text-muted">
                ...
                <td class="row_remove">
                    <a href="#" class="text-muted" id="${value.id}" onclick="compareRemove(this.id)"><i class="fi-rs-trash mr-5"></i><span>Remove</span> </a>
                </td>
                ...
                if(data.total){
                    ...
                    $('#couponCallField').html(
                        ` <tr>
                                        ...
                                        <td class="cart_total_amount">
                                            <h6 class="text-brand text-end">$${data.subtotal}</h6>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="cart_total_label">
                                    ...
                                    <tr>
                                        ...
                                        <td class="cart_total_amount">
                                            <h6 class="text-brand text-end">${data.total_amount}</h6>
                                        </td>
                                    </tr>`
                    )
                }
