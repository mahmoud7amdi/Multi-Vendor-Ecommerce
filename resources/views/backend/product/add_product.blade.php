                        ...
                        <div class="col-lg-8">
                            <div class="border border-3 p-4 rounded">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"  class="form-control visually-hidden" data-role="tagsinput" value="jQuery,Script,Net">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input name="product_thumbnail" class="form-control" type="file" onchange="mainThumUrl(this)">
                                    <img src="" id="mainThum">
                                </div>
                                <div class="form-group mb-3">
                            ...
                            <div class="border border-3 p-4 rounded">
                                <div class="row g-3">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="product_code" class="form-control" id="inputStarPoints" placeholder="00.00">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="inputCostPerPrice" class="form-label">Product Quantity</label>
                                        <input type="text" name="product_qty" class="form-control" id="inputCostPerPrice" placeholder="00.00">
                                    </div>
