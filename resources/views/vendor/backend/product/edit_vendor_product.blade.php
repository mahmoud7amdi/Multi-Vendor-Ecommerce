...
@section('vendor')
    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <hr/>
                <form id="myForm" method="post" action="{{ route('update.vendor.product') }}" >
                    @method('Put')
                    @csrf
                                ...
                                <div class="border border-3 p-4 rounded">
                                    <div class="row g-3">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="product_code" class="form-control" id="inputStarPoints" value="{{ $product->product_code }}">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="inputCostPerPrice" class="form-label">Product Quantity</label>
                                            <input type="text" name="product_qty" class="form-control" id="inputCostPerPrice" value="{{ $product->product_qty }}">
                                        </div>
                                        ...
                                        <div class="form-group col-12">
                                            <label for="inputCollection" class="form-label">Product Subategory</label>
    ...
    <div class="page-content">
        ...
        <hr>
        <div class="card">
            <form method="post" action="{{ route('update.vendor.product.thumbnail') }}" enctype="multipart/form-data" >
                @method('Put')
                @csrf
        ...
        <div class="card">
            <div class="card-body">
                <table class="table mb-0 table-striped">
                    ...
                    <form method="post" action="{{ route('update.vendor.product.multiImage') }}" enctype="multipart/form-data" >
                        @method('Put')
                        @csrf
                        ...
                        @foreach($multiImage as $key => $img)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('delete.vendor.multiImage.product',$img->id) }}" id="delete" class="btn btn-danger"> Delete </a>
                                </td>
                            </tr>
                        @endforeach
                    ...
                    $.each(data, function(index, file){ //loop though each file
                        if(/(\.|\/)(gif|jpe?g|png|webp)$/i.test(file.type)){ //check supported file type
                            ...
                            fRead.onload = (function(file){ //trigger function on successful read
                                return function(e) {
                                    const img = $('<img/>').addClass('thumb').attr('src', e.target.result).width(100)
